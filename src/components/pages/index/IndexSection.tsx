...
const SectionHeader: React.FC<SectionHeaderProps> = ({children, color}) => {
  return <div className={"flex items-center text-2xl font-light mb-8"}>
    <div className={`inline-block w-8 h-8 mr-4 ${SectionHeaderColors[color]}`} />
    {children}
  </div>
}
...
export const SectionItem: React.FC<SectionItemProps> = ({ name, href, desc}) => {
  return <div className="mt-3">
    <a href={href} className="text-xl font-medium">{name}</a>

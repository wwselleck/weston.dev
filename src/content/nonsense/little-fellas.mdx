...
<Achievement
  achievement={{
    name: "click-honey-bear",
    key: "click-honey-bear",
    description: "You clicked the honey bear!",
    icon: "🐻",
  }}
  client:only
>
...
## Blake's Hard Cider Mascot (Austin TX, November 2023)

![](https://i.imgur.com/tHE3ma4.jpg)
